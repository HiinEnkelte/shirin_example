...
public class MultiDomainTask {
	...
	public static void main(String[] args) throws Exception {
		...
		File[] files = new File("/home/shirin/topic_model/data//input//").listFiles();
	...
	public static double runPriorLDA(String domain) throws Exception {
		...
		List<String> vocab = Corpus.getVocab("/home/shirin/topic_model/data/input.vocab");
	...
	int K = 15;
		...
		int[][] docs = Corpus.getDocuments("/home/shirin/topic_model/data/input.docs");
