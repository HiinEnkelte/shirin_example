...
public class Conceptualization {
	...
	public static Map<String, Map<String, Double>> conceptualization(
		...
		List<String> vocab = Corpus.getVocab("/home/shirin/topic_model/data//" + domain
				+ ".vocab");

		int[][] docs = Corpus.getDocuments("/home/shirin/topic_model/data//" + domain
				+ ".docs");
...
public static void conceptualizations(Connection conn) throws IOException, SQLException {
				...
				BufferedReader reader = new BufferedReader(new InputStreamReader(
					...
					String line = "";
						while ((line = reader.readLine()) != null) {
							...
							Prior.getConceptualiztions(entities, conn);
								conn.close();
								    reader.close();
}
	/**
